...
const TextEditor::Palette& TextEditor::GetDarkPalette()
{
	const static Palette p = { {
			...
			ImColor(29,29,29,255), // Background
			0xffe0e0e0, // Cursor
			0x80a06020, // Selection
			0x800020ff, // ErrorMarker
			0x40f08000, // Breakpoint
			ImColor(32, 148, 186, 255), // Line number
...
const TextEditor::Palette& TextEditor::GetFakePalette()
{
	const static Palette p = { {
			ImColor(29,29,29,255),	// Default
			0xffd69c56,	// Keyword	
			ImColor(29,29,29,255),	// Number
			ImColor(29,29,29,255),	// String
			0xff70a0e0, // Char literal
			0xffffffff, // Punctuation
			0xff408080,	// Preprocessor
			0xffaaaaaa, // Identifier
			...
			0xffe0e0e0, // Cursor
			0x80a06020, // Selection
			ImColor(29,29,29,255), // ErrorMarker
			ImColor(29,29,29,255), // Breakpoint
			ImColor(29,29,29,255), // Line number,
			0x40000000, // Current line fill
			0x40808080, // Current line fill (inactive)
			0x40a0a0a0, // Current line edge
		} };
...
{
	const static Palette p = { {
			ImColor(255,0,0,255),	// Default				|| red
			ImColor(0,0,255,255),	// Keyword				|| Yellow
			ImColor(0,0,255,255),	// Number				|| Purple
			ImColor(255,0,0,255),	// String				|| red
			0xff70a0e0, // Char literal			|| Pinkish
			0xffffffff, // Punctuation			|| White
			0xff408080,	// Preprocessor			|| Pink
			0xffaaaaaa, // Identifier			|| Pinkish color sorta mixed with red
			0xff9bc64d, // Known identifier		|| Pink
			0xffc040a0, // Preproc identifier   || Yellow
			ImColor(0,255,0,255), // Comment (single line)|| Pink wtf
			ImColor(0,255,0,255), // Comment (multi line)
			ImColor(25,25,25,255), // Background|| red somehow lmfao
			0xffe0e0e0, // Cursor				|| White	
			ImColor(0.30,0.30,0.30, 120), // Selection			|| Green smh
			0x800020ff, // ErrorMarker
			0x40f08000, // Breakpoint
			ImColor(238, 0, 38,255), // Line number,
			0x40000000, // Current line fill
			0x40808080, // Current line fill (inactive)
			0x40a0a0a0, // Current line edge
		} };
